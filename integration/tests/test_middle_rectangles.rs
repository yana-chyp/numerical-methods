...
fn test_middle_rectangles() {
    ...
    println!("for f(x) = 1/(1+x) approx = {:.4}, n = {}", integ_approx, n);
    println!("error = {:.8}\n", (integ_exact - integ_approx).abs());
